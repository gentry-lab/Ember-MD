 ...
 *
 * With our Metal dispatch model (one command buffer per kernel, waitUntilCompleted
 * after each), all prior GPU work is synchronously complete before the next
 * host-side call. Events therefore reduce to a simple atomic flag.
 */
