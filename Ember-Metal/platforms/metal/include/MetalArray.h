...
/**
 * This class encapsulates a Metal Buffer.  It provides a simplified API for working with it,
...
public:
     ...
     * @param flags             flags for buffer creation (0 = default read/write)
     */
    template <class T>
    static MetalArray* create(MetalContext& context, size_t size, const std::string& name, int flags = 0) {
     ...
     *
     * @param context           the context for which to create the array
     * @param buffer            the Metal Buffer (id<MTLBuffer>) this object encapsulates
     * @param size              the number of elements in the array
     * @param name              the name of the array
     */
    template <class T>
    static MetalArray* create(MetalContext& context, void* buffer, size_t size, const std::string& name) {
     ...
     * @param flags             flags for buffer creation (0 = default read/write)
     */
    MetalArray(MetalContext& context, size_t size, int elementSize, const std::string& name, int flags = 0);
    /**
     ...
     * @param name              the name of the array
     */
    MetalArray(MetalContext& context, void* buffer, size_t size, int elementSize, const std::string& name);
    ~MetalArray();
    /**
     ...
     * @param flags             flags for buffer creation (0 = default read/write)
     */
    void initialize(MetalContext& context, size_t size, int elementSize, const std::string& name, int flags);
    /**
     ...
     * @param name              the name of the array
     */
    void initialize(MetalContext& context, void* buffer, size_t size, int elementSize, const std::string& name);
    /**
     ...
     */
    template <class T>
    void initialize(MetalContext& context, size_t size, const std::string& name, int flags = 0) {
     ...
     */
    template <class T>
    void initialize(MetalContext& context, void* buffer, size_t size, const std::string& name) {
    ...
    /**
     * Get the Metal Buffer object (id<MTLBuffer>).
     * In .mm files, cast the return value to id<MTLBuffer>.
     */
