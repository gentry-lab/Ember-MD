...
KERNEL void execFFT(GLOBAL const INPUT_TYPE* restrict in, GLOBAL OUTPUT_TYPE* restrict out, LOCAL real2* restrict w,
        LOCAL real2* restrict data0, LOCAL real2* restrict data1,
        MM_THREAD_ARGS) {
