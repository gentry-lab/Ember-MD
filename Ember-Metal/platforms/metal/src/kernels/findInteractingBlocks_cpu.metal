...
KERNEL void sortBoxData(GLOBAL const real2* restrict sortedBlock, GLOBAL const real4* restrict blockCenter,
        GLOBAL const real4* restrict blockBoundingBox, GLOBAL real4* restrict sortedBlockCenter,
        GLOBAL real4* restrict sortedBlockBoundingBox, GLOBAL const real4* restrict posq, GLOBAL const real4* restrict oldPositions,
 ...
 * to global memory.
 */
void storeInteractionData(int x, int* buffer, int* atoms, int* numAtoms, int numValid, GLOBAL unsigned int* interactionCount,
            GLOBAL int* interactingTiles, GLOBAL unsigned int* interactingAtoms, real4 periodicBoxSize, real4 invPeriodicBoxSize, real4 periodicBoxVecX,
            real4 periodicBoxVecY, real4 periodicBoxVecZ, GLOBAL const real4* posq, real4 blockCenterX, real4 blockSizeX, unsigned int maxTiles, bool finish) {
